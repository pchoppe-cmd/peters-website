...
const I18N = {
  en: {
    ...
    shop_banner: "The Sand Timer and Puzzle below are ready to order — the Torch is still coming together!",
  ...
  de: {
    ...
    shop_banner: "Die Sanduhr und das Puzzle unten können bereits bestellt werden — die Taschenlampe folgt in Kürze!",
  ...
  fr: {
    ...
    shop_banner: "Le sablier et le casse-tête ci-dessous sont prêts à commander — la lampe torche arrive bientôt !",
  ...
  es: {
    ...
    shop_banner: "El reloj de arena y el puzzle de abajo ya se pueden pedir — ¡la linterna llegará pronto!",
