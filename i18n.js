...
const I18N = {
  en: {
    ...
    shop_subtitle: "A few fun little things we love.",
  ...
  de: {
    ...
    shop_subtitle: "Ein paar schöne Kleinigkeiten, die wir lieben.",
  ...
  fr: {
    ...
    shop_subtitle: "Quelques petites choses sympas que nous aimons.",
  ...
  es: {
    ...
    shop_subtitle: "Algunas cosas pequeñas y divertidas que nos encantan.",
