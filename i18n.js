...
const I18N = {
  en: {
    ...
    about_built_html: "Plain HTML, CSS, and JavaScript — no frameworks, no build step, just privacy-friendly, cookie-free analytics (Cloudflare Web Analytics). The Word Scrambler works fully offline in English, and downloads a small dictionary the first time you switch it to German, French, or Spanish. The Currency Converter fetches live rates from the free <a href=\"https://frankfurter.dev\" target=\"_blank\" rel=\"noopener\">frankfurter.dev</a> API.",
    ...
    privacy_cookies_text: "This site itself does not set cookies. It uses Cloudflare Web Analytics to see how many people visit, which works without cookies or any cross-site tracking. If advertising is enabled in future, the ad provider may set cookies as described above.",
    ...
    unit_kilowatt: "Kilowatts (kW)", unit_horsepower: "Horsepower (HP)", unit_watt: "Watts (W)",

    nav_shop: "Shop",
    shop_badge: "Shop",
    shop_title: "The Scrambledamble Shop",
    shop_subtitle: "A few fun little things, coming soon.",
    shop_banner: "This is a preview — checkout isn't live yet. Real products and prices are on the way!",
    shop_sandtimer_name: "5-Minute Sand Timer",
    shop_sandtimer_desc: "A simple hourglass for tea, games, or beating procrastination one grain at a time.",
    shop_torch_name: "Pocket Torch",
    shop_torch_desc: "A compact, rechargeable torch small enough for a pocket, bright enough to actually use.",
    shop_puzzle_name: "Metal Disentanglement Puzzle",
    shop_puzzle_desc: "Untangle the interlocking metal pieces to solve this classic brain teaser.",
  ...
  de: {
    ...
    about_built_html: "Reines HTML, CSS und JavaScript — keine Frameworks, kein Build-Prozess, nur datenschutzfreundliche, cookie-freie Analyse (Cloudflare Web Analytics). Der Buchstabensalat funktioniert auf Englisch komplett offline und lädt beim ersten Wechsel zu Deutsch, Französisch oder Spanisch ein kleines Wörterbuch nach. Der Währungsrechner ruft aktuelle Kurse über die kostenlose <a href=\"https://frankfurter.dev\" target=\"_blank\" rel=\"noopener\">frankfurter.dev</a>-API ab.",
    about_feedback_heading: "Feedback",
    ...
    privacy_cookies_heading: "Cookies",
    privacy_cookies_text: "Diese Seite selbst setzt keine Cookies. Sie verwendet Cloudflare Web Analytics, um zu sehen, wie viele Personen die Seite besuchen — das funktioniert ohne Cookies und ohne seitenübergreifendes Tracking. Falls künftig Werbung aktiviert wird, kann der Werbeanbieter wie oben beschrieben Cookies setzen.",
    ...
    unit_mpg_uk: "MPG (UK)", unit_mpg_us: "MPG (US)", unit_l_100km: "L/100km",
    unit_kilowatt: "Kilowatt (kW)", unit_horsepower: "Pferdestärke (HP)", unit_watt: "Watt (W)",

    nav_shop: "Shop",
    shop_badge: "Shop",
    shop_title: "Der Scrambledamble-Shop",
    shop_subtitle: "Ein paar schöne Kleinigkeiten, bald verfügbar.",
    shop_banner: "Dies ist eine Vorschau — der Checkout ist noch nicht aktiv. Echte Produkte und Preise folgen in Kürze!",
    shop_sandtimer_name: "5-Minuten-Sanduhr",
    shop_sandtimer_desc: "Eine einfache Sanduhr für Tee, Spiele oder um die Prokrastination Korn für Korn zu besiegen.",
    shop_torch_name: "Taschenlampe",
    shop_torch_desc: "Eine kompakte, wiederaufladbare Taschenlampe — klein genug für die Tasche, hell genug für den echten Einsatz.",
    shop_puzzle_name: "Metall-Knobelpuzzle",
    shop_puzzle_desc: "Löse die ineinander verschlungenen Metallteile — ein klassisches Denkspiel.",
    shop_coming_soon: "Bald verfügbar",
  ...
  fr: {
    ...
    privacy_cookies_heading: "Cookies",
    privacy_cookies_text: "Ce site lui-même ne dépose pas de cookies. Il utilise Cloudflare Web Analytics pour voir combien de personnes le visitent, ce qui fonctionne sans cookies ni suivi entre sites. Si de la publicité est activée à l'avenir, le fournisseur publicitaire peut déposer des cookies comme décrit ci-dessus.",
    ...
    unit_mpg_uk: "MPG (UK)", unit_mpg_us: "MPG (US)", unit_l_100km: "L/100km",
    unit_kilowatt: "Kilowatts (kW)", unit_horsepower: "Chevaux-vapeur (HP)", unit_watt: "Watts (W)",

    nav_shop: "Boutique",
    shop_badge: "Boutique",
    shop_title: "La boutique Scrambledamble",
    shop_subtitle: "Quelques petites choses sympas, bientôt disponibles.",
    shop_banner: "Ceci est un aperçu — le paiement n'est pas encore actif. De vrais produits et prix arrivent bientôt !",
    shop_sandtimer_name: "Sablier 5 minutes",
    shop_sandtimer_desc: "Un simple sablier pour le thé, les jeux, ou pour vaincre la procrastination grain par grain.",
    shop_torch_name: "Lampe torche de poche",
    shop_torch_desc: "Une lampe torche compacte et rechargeable, assez petite pour une poche, assez puissante pour être vraiment utile.",
    shop_puzzle_name: "Casse-tête métallique à démêler",
    shop_puzzle_desc: "Démêlez les pièces métalliques entrelacées pour résoudre ce casse-tête classique.",
  ...
  es: {
    ...
    about_built_html: "HTML, CSS y JavaScript sencillos — sin frameworks, sin proceso de compilación, solo análisis respetuoso con la privacidad y sin cookies (Cloudflare Web Analytics). La Sopa de letras funciona completamente sin conexión en inglés, y descarga un pequeño diccionario la primera vez que cambias a alemán, francés o español. El Conversor de divisas obtiene tipos de cambio en vivo de la API gratuita <a href=\"https://frankfurter.dev\" target=\"_blank\" rel=\"noopener\">frankfurter.dev</a>.",
    ...
    privacy_cookies_heading: "Cookies",
    privacy_cookies_text: "Este sitio en sí no utiliza cookies. Utiliza Cloudflare Web Analytics para ver cuántas personas lo visitan, lo cual funciona sin cookies ni seguimiento entre sitios. Si en el futuro se activa la publicidad, el proveedor de anuncios puede usar cookies como se describe arriba.",
    ...
    unit_mpg_uk: "MPG (UK)", unit_mpg_us: "MPG (US)", unit_l_100km: "L/100km",
    unit_kilowatt: "Kilovatios (kW)", unit_horsepower: "Caballos de fuerza (HP)", unit_watt: "Vatios (W)",

    nav_shop: "Tienda",
    shop_badge: "Tienda",
    shop_title: "La tienda Scrambledamble",
    shop_subtitle: "Algunas cosas pequeñas y divertidas, próximamente.",
    shop_banner: "Esto es una vista previa — el pago aún no está activo. ¡Pronto habrá productos y precios reales!",
    shop_sandtimer_name: "Reloj de arena de 5 minutos",
    shop_sandtimer_desc: "Un sencillo reloj de arena para el té, los juegos, o para vencer la procrastinación grano a grano.",
    shop_torch_name: "Linterna de bolsillo",
    shop_torch_desc: "Una linterna compacta y recargable, lo bastante pequeña para el bolsillo y lo bastante potente para ser realmente útil.",
    shop_puzzle_name: "Puzzle metálico para desenredar",
    shop_puzzle_desc: "Desenreda las piezas metálicas entrelazadas para resolver este clásico rompecabezas.",
