...
const I18N = {
  en: {
    ...
    shop_banner: "The Sand Timer below is ready to order — the rest of the shop is still coming together!",
  ...
  de: {
    ...
    shop_banner: "Die Sanduhr unten kann bereits bestellt werden — der Rest des Shops folgt in Kürze!",
  ...
  fr: {
    ...
    shop_banner: "Le sablier ci-dessous est prêt à commander — le reste de la boutique arrive bientôt !",
  ...
  es: {
    ...
    shop_banner: "El reloj de arena de abajo ya se puede pedir — ¡el resto de la tienda llegará pronto!",
